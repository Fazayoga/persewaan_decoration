...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/decor-2.jpeg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/decor-2.jpeg);">
					</div>
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <p><a href="{{ route('decor') }}" class="btn btn-primary py-3 px-4">Search Decoration</a></p>
	          </div>
					</div>
				</div>
			</div>
		...
		<section class="ftco-section ftco-intro" style="background-image: url(images/decor-1.jpeg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row justify-content-end">
					<div class="col-md-6 heading-section heading-section-white ftco-animate">
            <h2 class="mb-3">Do You Want To Earn With Us? So Don't Be Late.</h2>
            <a href="{{ route('decor') }}" class="btn btn-primary btn-lg">Become A Wedding organizer</a>
          </div>
				</div>
			</div>
		</section>
