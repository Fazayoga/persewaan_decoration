...
<html lang="en">
  ...
  <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/decor-3.jpeg');" data-stellar-background-ratio="0.5">
            ...
            @foreach($pakets as $paket)
              <div class="car-list">
                <table class="table">
                  ...
                  <tbody>
                    <tr class="">
                      <td class="car-image"><div class="img rounded d-flex align-items-end" style="background-image: url('{{ asset($paket->gambar) }}');"></td>
                      ...
                      <td class="price">
                        <p class="btn-custom"><a href="#">Rent a decor</a></p>
